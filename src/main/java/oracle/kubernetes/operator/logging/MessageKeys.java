...
public class MessageKeys {
  ...
  public static final String WAITING_FOR_POD_DELETE = "WLSKO-0088";
  public static final String POD_IS_READY = "WLSKO-0089";
  public static final String POD_IS_FAILED = "WLSKO-0090";
  public static final String POD_IS_DELETED = "WLSKO-0091";
  public static final String EXCH_UNEQUAL_LISTEN_PORTS = "WLSKO-0092";
  public static final String EXCH_WRONG_PROTOCOL = "WLSKO-0093";
  public static final String EXCH_CHANNEL_NOT_DEFINED = "WLSKO-0094";
  public static final String EXCH_OUTSIDE_RANGE="WLSKO-0095";
  public static final String ASYNC_REQUEST = "WLSKO-0096";
  public static final String ASYNC_FAILURE = "WLSKO-0097";
  public static final String ASYNC_SUCCESS = "WLSKO-0098";
  public static final String ASYNC_NO_RETRY = "WLSKO-0099";
  public static final String ASYNC_RETRY = "WLSKO-0100";
  public static final String ASYNC_TIMEOUT = "WLSKO-0101";
  public static final String WATCH_REQUEST = "WLSKO-0102";
  public static final String WATCH_EVENT = "WLSKO-0103";
  public static final String DOMAIN_STATUS = "WLSKO-0104";
  public static final String INVALID_MANAGE_SERVER_COUNT = "WLSKO-0105";
  public static final String SCALE_COUNT_GREATER_THAN_CONFIGURED = "WLSKO-0106";
  public static final String SCALING_AUTO_CONTROL_AUTO = "WLSKO-0107";
  public static final String MATCHING_DOMAIN_NOT_FOUND = "WLSKO-0108";
  public static final String INVALID_DOMAIN_UID = "WLSKO-0109";
  public static final String NULL_DOMAIN_UID = "WLSKO-0110";
  public static final String NULL_TOKEN_REVIEW_STATUS = "WLSKO-0111";
  public static final String NULL_USER_INFO = "WLSKO-0112";
  public static final String RESOURCE_BUNDLE_NOT_FOUND = "WLSKO-0113";
  public static final String RESTART_ADMIN_COMPLETE = "WLSKO-0114";
  public static final String RESTART_SERVERS_COMPLETE = "WLSKO-0115";
  public static final String ROLLING_CLUSTERS_COMPLETE = "WLSKO-0116";
  public static final String RESTART_ADMIN_STARTING = "WLSKO-0117";
  public static final String RESTART_SERVERS_STARTING = "WLSKO-0118";
  public static final String ROLLING_CLUSTERS_STARTING = "WLSKO-0119";
  public static final String CYCLING_SERVERS = "WLSKO-0120";
  public static final String ROLLING_SERVERS = "WLSKO-0122";
  public static final String REMOVING_INGRESS = "WLSKO-0123";
  public static final String LIST_INGRESS_FOR_DOMAIN = "WLSKO-0123";
  public static final String POD_DELETED = "WLSKO-0124";
  public static final String SERVER_SERVICE_DELETED = "WLSKO-0125";
  public static final String CLUSTER_SERVICE_DELETED = "WLSKO-0126";
  public static final String INGRESS_DELETED = "WLSKO-0127";
